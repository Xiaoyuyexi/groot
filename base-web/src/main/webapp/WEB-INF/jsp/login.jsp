...
<script type="text/javascript" src="resources/js/hkrt.js"></script>
<title>Login to Acceptance Management System</title>
<!-- Stylesheets -->
...
<body onload="sessionTimeOut();">
	...
	<div id="header">
		...
		<div class="page-full-width">
			...
			<div id="login-intro">
				...
				<h1>Login to Acceptance Management System</h1>
	...
	<div id="content">
		...
		<form action="main.jhtml" method="post" id="login-form">

			<fieldset>

				<p>
					<label for="login-username">username</label> <input type="text"
						name="loginName" id="username" class="round full-width-input" value='${MSG.content }'/>
				</p>

				<p>
					<label for="login-password">password</label> <input type="password"
						name="password" class="round full-width-input"/>
				</p>
				...
				<c:if test="${MSG.status!=false}">
					<label><span>验证码</span><span><a href="#" onclick="changeCode()" style="font-size: 12px;margin-left: 46px;">换一张</a></span></label>
						...
						<input type="submit" class="login-button round button-blue" style="width:100px;height:40px;float:left;margin-left: 2px;font-size:12px;"
					value="LOG IN" />
				</p>
				<br/>
	...
	<div id="footer">
		...
		<p class="footCopyright">
			Copyright &#169; 2012-2013 <a href="http://www.hkrt.cn/">XXXXXXXXXXXXXXX</a>
			版权所有
		</p>
